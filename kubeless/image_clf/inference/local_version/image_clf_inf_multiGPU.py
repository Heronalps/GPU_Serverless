...
def handler(event, context): 
    ...
    print ("Time with model loading: {0} Time without model loading {1} for {2} images.".format(end - start1, end - start2, NUM_IMAGE))
    return ("Time with model loading: {0} Time without model loading {1} for {2} images.".format(end - start1, end - start2, NUM_IMAGE))
